...
data1 = data_get_dead['MEDICAL_UNIT']
data2 = data_get_alive['MEDICAL_UNIT']
...
plt.xlabel('MEDICAL_UNIT Group')
plt.ylabel('Proportion')
plt.title('Bar chart of MEDICAL_UNIT impacting on death')
plt.xticks([i + bar_width / 2 for i in index], keys, rotation=90)
plt.legend()
plt.tight_layout()
plt.savefig('./MEDICAL_UNIT.png', dpi=200)
plt.show()